...
[![x-cmd/install — pass-cli Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/pass-cli.svg?lang=zh)](https://x-cmd.com/install/pass-cli)
...
- **上游仓库**: <https://github.com/ari1110/pass-cli>
- **官网**: <https://reyamira.github.io/pass-cli/>
- **许可证**: Apache-2.0
...
- **Star**: 110 · **Fork**: 4 · **开放 issue**: 20 · **贡献者**: 5

## 累计统计

- **发布数**: 37 · **已合并 PR**: 101 · **开放 PR**: 11 · **已关闭 issue**: 16 · **开放 issue**: 4 · **提交数**: 941
...
pass-cli 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `pass-cli` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/pass-cli.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:16:33Z._
